...
// Inline SVG rather than an icon package: eight glyphs do not justify a dependency, and
// `currentColor` lets each one inherit its button's hover and focus colors for free.
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  tiktok: (
    <path
      fill="currentColor"
      d="M16.6 5.82A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5 2.59 2.59 0 0 1 0-5.18c.27 0 .52.04.76.12v-3.15a5.9 5.9 0 0 0-.76-.05A5.72 5.72 0 0 0 4.14 15.3 5.72 5.72 0 0 0 9.86 21a5.72 5.72 0 0 0 5.72-5.72V9.01a7.35 7.35 0 0 0 4.28 1.38V7.3a4.28 4.28 0 0 1-3.26-1.48z"
    />
  ),
  book: (
    <>
...
export const Icon: React.FC<{ name: IconName; size?: number }> = ({ name, size = 18 }) => (
  <svg
    ...
    strokeWidth={STROKED.has(name) ? 2 : undefined}
    strokeLinecap="round"
